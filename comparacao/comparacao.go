...
func Comparar(antes, depois metrica.Documento) Comparacao {
	c := Comparacao{
...
func identificar(documento metrica.Documento) Identificacao {
...
func levantarRessalvas(antes, depois metrica.Documento) []string {
...
func planoResumido(documento metrica.Documento) string {
...
func compararPassos(antes, depois metrica.Documento) []DiferencaDePasso {
	porNome := func(documento metrica.Documento) map[string]metrica.ResultadoDePasso {
		mapa := map[string]metrica.ResultadoDePasso{}
...
func compararErro(antes, depois metrica.Documento) DiferencaDeContagem {
...
func frasear(c Comparacao, antes, depois metrica.Documento) string {
	if !c.Comparavel {
