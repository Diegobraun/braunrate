...
func ClasseLegivel(classe protocol.ClasseDeErro) string {
	switch classe {
	case protocol.ErroDeRede:
		return "falha de rede"
	case protocol.ErroDeTimeout:
		return "timeout"
	case protocol.ErroDeStatus:
		return "status HTTP inesperado"
	case protocol.ErroDeAssercao:
		return "assercao funcional"
	case protocol.ErroDeCorrelacao:
		return "correlacao perdida"
	case protocol.ErroDeSaturacao:
		return "saturacao do gerador"
	case protocol.ErroDeGraphQL:
