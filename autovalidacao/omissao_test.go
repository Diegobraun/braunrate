...
func subirAlvoQueCongela(t *testing.T) *alvo.Servidor {
	t.Helper()
...
func executarEmModeloAberto(t *testing.T, endereco string) metrica.Documento {
	t.Helper()
	c := cenario.Cenario{
		...
		Carga: cenario.PlanoDeCarga{
			...
			Fases:  []cenario.Fase{{Tipo: cenario.FaseConstante, Ate: taxaDaExecucao, Durante: duracaoDaExecucao}},
		},
